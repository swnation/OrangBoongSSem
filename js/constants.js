...
const APP_VERSION = [
  {v:'v9.8.8', date:'2026-04-29', note:'검사아카이브접기·약물복용법(일투수 QD/BID/TID/QID + 1회 복용량 T/정/ml/포)'},
...
■ 기본
- 유성우(붕쌤), 남성 38세(1988년생), 1차 진료 일반의 (고회전 외래)
...
■ 기본
- 유성우(붕쌤), 남성 38세(1988년생), 1차 진료 일반의
...
■ 기본
- 첫째 태명: 붕룩이
- 엄마: 김나연(오랑이), 여성 28세(1997년생), 체중 39~42kg
- 아빠: 유성우(붕쌤), 남성 38세(1988년생), 1차 진료 일반의
