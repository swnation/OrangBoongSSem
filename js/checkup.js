...
const _CHECKUP_STD_TESTS = {
  ...
  WBC:  { name:{ko:'백혈구',en:'WBC'}, unit:'10^3/μL', category:'cbc', ref:{low:4.0,high:10.0},
    aliases:['wbc','백혈구','백혈구수','white blood cell','wbc count','w.b.c','cwbc','cwbc1'], related:['RBC','HGB','PLT'], pregnancyRelevant:false },
  RBC:  { name:{ko:'적혈구',en:'RBC'}, unit:'10^6/μL', category:'cbc', ref:{male:{low:4.5,high:5.5},female:{low:4.0,high:5.0}},
    aliases:['rbc','적혈구','적혈구수','red blood cell','rbc count','r.b.c','crbc','crbc1'], related:['WBC','HGB','HCT'], pregnancyRelevant:false },
  HGB:  { name:{ko:'혈색소',en:'Hemoglobin'}, unit:'g/dL', category:'cbc', ref:{male:{low:13.0,high:17.0},female:{low:12.0,high:16.0}},
    aliases:['hemoglobin','hgb','hb','혈색소','헤모글로빈','hemoglobin(hb)','chb','chb1'], related:['RBC','HCT'], pregnancyRelevant:true },
  HCT:  { name:{ko:'헤마토크릿',en:'Hematocrit'}, unit:'%', category:'cbc', ref:{male:{low:39,high:51},female:{low:36,high:48}},
    aliases:['hematocrit','hct','헤마토크릿','적혈구용적률','chct','chct1'], related:['RBC','HGB'], pregnancyRelevant:false },
  PLT:  { name:{ko:'혈소판',en:'Platelet'}, unit:'10^3/μL', category:'cbc', ref:{low:150,high:400},
    aliases:['platelet','plt','혈소판','혈소판수','platelet count','cplat','cplat1'], related:['WBC','RBC'], pregnancyRelevant:true },
  MCV:  { name:{ko:'평균적혈구용적',en:'MCV'}, unit:'fL', category:'cbc', ref:{low:80,high:100},
    aliases:['mcv','평균적혈구용적','mean corpuscular volume','cmcv','cmcv1'], related:['MCH','MCHC','RDW'], pregnancyRelevant:false },
  MCH:  { name:{ko:'평균적혈구혈색소량',en:'MCH'}, unit:'pg', category:'cbc', ref:{low:27,high:33},
    aliases:['mch','평균적혈구혈색소량','mean corpuscular hemoglobin','cmch','cmch1'], related:['MCV','MCHC'], pregnancyRelevant:false },
  MCHC: { name:{ko:'평균적혈구혈색소농도',en:'MCHC'}, unit:'g/dL', category:'cbc', ref:{low:32,high:36},
    aliases:['mchc','평균적혈구혈색소농도','cmchc','cmchc1'], related:['MCV','MCH'], pregnancyRelevant:false },
  RDW:  { name:{ko:'적혈구분포폭',en:'RDW'}, unit:'%', category:'cbc', ref:{low:11.5,high:14.5},
    aliases:['rdw','적혈구분포폭','rdw-cv','rdw cv','crdw'], related:['MCV'], pregnancyRelevant:false },
  MPV:  { name:{ko:'평균혈소판용적',en:'MPV'}, unit:'fL', category:'cbc', ref:{low:7.5,high:11.5},
    aliases:['mpv','평균혈소판용적','mean platelet volume','cmcv2'], related:['PLT'], pregnancyRelevant:false },
  ...
  LYMPH:{ name:{ko:'림프구',en:'Lymphocyte'}, unit:'%', category:'cbc', ref:{low:20,high:44},
    aliases:['lymphocyte','lymph','림프구','lympho','lymp'], related:['NEUT','MONO'], pregnancyRelevant:false },
  ...
  EOS:  { name:{ko:'호산구',en:'Eosinophil'}, unit:'%', category:'cbc', ref:{low:0,high:5},
    aliases:['eosinophil','eos','호산구','eosino','eosi'], related:['NEUT','BASO'], pregnancyRelevant:false },
  ...
  AST:  { name:{ko:'AST(GOT)',en:'AST'}, unit:'U/L', category:'liver', ref:{low:0,high:40},
    aliases:['ast','got','sgot','ast(got)','got(ast)','아스파르테이트','s-got','s-ast','got'], related:['ALT','GGT','ALP','TBIL'], pregnancyRelevant:false },
  ALT:  { name:{ko:'ALT(GPT)',en:'ALT'}, unit:'U/L', category:'liver', ref:{low:0,high:40},
    aliases:['alt','gpt','sgpt','alt(gpt)','gpt(alt)','알라닌','s-gpt','s-alt','gpt'], related:['AST','GGT','ALP','TBIL'], pregnancyRelevant:false },
  GGT:  { name:{ko:'감마지티피',en:'GGT'}, unit:'U/L', category:'liver', ref:{male:{low:0,high:60},female:{low:0,high:40}},
    aliases:['ggt','γ-gtp','r-gtp','감마지티피','gamma-gtp','gamma gt','r-gt','γgtp','감마gt','감마 지티피','gtp'], related:['AST','ALT'], pregnancyRelevant:false },
  ...
  LDL:  { name:{ko:'LDL콜레스테롤',en:'LDL'}, unit:'mg/dL', category:'lipid', ref:{low:0,high:130},
    aliases:['ldl','ldl-c','ldl cholesterol','ldl콜레스테롤','ldl 콜레스테롤','ldl-cholesterol','c199'], related:['TCHOL','TG','HDL'], pregnancyRelevant:false,
    conversions:{'mmol/L':{factor:38.67}} },
  ...
  HBA1C:{ name:{ko:'당화혈색소',en:'HbA1c'}, unit:'%', category:'glucose', ref:{low:4.0,high:6.0},
    aliases:['hba1c','a1c','glycated hemoglobin','당화혈색소','당화 혈색소','hemoglobin a1c','glycohemoglobin','hb a1c','hba1c1','hbngsp','hbifcc'], related:['GLU','INSULIN'], pregnancyRelevant:true },
  ...
  CRP:  { name:{ko:'C반응단백',en:'CRP'}, unit:'mg/dL', category:'inflammation', ref:{low:0,high:0.5},
    aliases:['crp','c-reactive protein','c반응단백','c반응성단백','c-반응단백','crp정량','crpa'], related:['HSCRP','ESR'], pregnancyRelevant:false },
  ...
  ESR:  { name:{ko:'적혈구침강속도',en:'ESR'}, unit:'mm/hr', category:'inflammation', ref:{male:{low:0,high:15},female:{low:0,high:20}},
    aliases:['esr','적혈구침강속도','sed rate','erythrocyte sedimentation rate','혈침','h108'], related:['CRP'], pregnancyRelevant:false },
  ...
  VITD: { name:{ko:'비타민D',en:'Vitamin D'}, unit:'ng/mL', category:'vitamin', ref:{low:20,high:100},
    aliases:['vitamin d','vit d','비타민d','25-oh vitamin d','25-oh','25(oh)d','25-hydroxyvitamin d','비타민 d','25-oh-d','calcidiol','vitd1'], related:['CA'], pregnancyRelevant:true,
  ...
  PT:   { name:{ko:'프로트롬빈시간',en:'PT'}, unit:'sec', category:'coagulation', ref:{low:11,high:14},
    aliases:['pt','프로트롬빈시간','prothrombin time','프로트롬빈 시간','pt2','pt3'], related:['APTT','INR'], pregnancyRelevant:false },
  ...
  UPROT:{ name:{ko:'소변단백',en:'Urine Protein'}, unit:'qualitative', category:'urine', ref:{low:0,high:0},
    aliases:['urine protein','u-protein','소변단백','요단백','소변 단백','protein(urine)','u-prot','upro','upro1'], related:['UBLOOD'], pregnancyRelevant:true },
