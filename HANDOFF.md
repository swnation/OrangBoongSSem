...
## 미완료 — 추가해야 할 JavaScript 함수들

아래 기능의 **CSS는 완료**, **JS 함수 구현이 필요**합니다.
모든 함수는 `index.html`의 `</script>` 태그 직전 (서비스워커 등록 직전)에 추가.
