...
- `backup/v9.8.8` (2026-05-03) ← 검사 아카이브 접기 + 약물 복용법(일투수·1회 복용량)
- `backup/v9.8.7` (2026-04-29)
- `backup/v9.8.6` (2026-04-22)
- `backup/v9.8.5` (2026-04-22)
- `backup/v9.8.3` (2026-04-22)
- `backup/v9.8.2` (2026-04-22) ⚠️ **삭제 필요** (자동 삭제 403 실패 — 초과 2건)
- `backup/v9.8` (2026-04-21) ⚠️ **삭제 필요** (자동 삭제 403 실패 — 초과 2건)
