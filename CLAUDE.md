...
- `backup/v9.8.3` (2026-04-22) ← 기본모드 환자설명용 회귀 수정 + 통합검증
- `backup/v9.8.2` (2026-04-22) ← v9.8.1(약물 주기) + v9.8.2(세션 프롬프트 위생·Opus4.7) 통합
- `backup/v9.8` (2026-04-21)
- `backup/v9.7`
- `backup/v9.6`
- `backup/v9.5` ⚠️ **삭제 필요** (자동 삭제 403 실패)
- `backup/v9.4` ⚠️ **삭제 필요** (자동 삭제 403 실패 — 연속 미삭제)
